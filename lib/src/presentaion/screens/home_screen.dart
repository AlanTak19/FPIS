...
class _HomeScreenState extends ConsumerState<HomeScreen>
  ...
  Widget build(BuildContext context) {
    ...
    if (lastMessage != null) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        if (!(lastMessage.notification!.title!.contains("сообщение") ||
            lastMessage.notification!.title!.contains("message"))) {
          showAlertDialog(
              context: context,
              message:
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (ref.read(connectionStateProvider) == true &&
      ...
      } else if (ref.read(connectionStateProvider) == true &&
  ...
  Widget _buildTab({required int index, required IconData icon}) {
